...
int gen_instr_valid()
{
    return ((if_id_next->icode) == (I_NOP) || (if_id_next->icode) == 
      ...
      (if_id_next->icode) == (I_MUTEXTEST) || (if_id_next->icode) == 
      (I_MUTEXCLEAR));
}
...
int gen_d_srcA()
{
    return (((if_id_curr->icode) == (I_RRMOVL) || (if_id_curr->icode) == 
        (I_RMMOVL) || (if_id_curr->icode) == (I_ALU) || (if_id_curr->icode)
         == (I_PUSHL) || (if_id_curr->icode) == (I_MUTEXTEST)) ? 
...
int gen_d_dstM()
{
    return (((if_id_curr->icode) == (I_MRMOVL) || (if_id_curr->icode) == 
        (I_POPL) || (if_id_curr->icode) == (I_MUTEXTEST)) ? 
      (if_id_curr->ra) : ((if_id_curr->icode) == (I_LEAVE)) ? (REG_EBP) : 
      (REG_NONE));
}
...
int gen_mem_read()
{
    return ((ex_mem_curr->icode) == (I_MRMOVL) || (ex_mem_curr->icode) == 
      (I_POPL) || (ex_mem_curr->icode) == (I_RET) || (ex_mem_curr->icode)
       == (I_LEAVE) || (ex_mem_curr->icode) == (I_MUTEXTEST));
}
...
int gen_mem_write()
{
    return ((ex_mem_curr->icode) == (I_RMMOVL) || (ex_mem_curr->icode) == 
      (I_PUSHL) || (ex_mem_curr->icode) == (I_CALL) || (ex_mem_curr->icode)
       == (I_MUTEXTEST) || (ex_mem_curr->icode) == (I_MUTEXCLEAR));
}
...
int gen_F_stall()
{
    return ((((id_ex_curr->icode) == (I_MRMOVL) || (id_ex_curr->icode) == 
          ...
          (id_ex_curr->icode) == (I_MUTEXTEST)) & ((id_ex_curr->destm) == 
...
int gen_D_stall()
{
    return (((id_ex_curr->icode) == (I_MRMOVL) || (id_ex_curr->icode) == 
        (I_POPL) || (id_ex_curr->icode) == (I_LEAVE) || (id_ex_curr->icode)
         == (I_MUTEXTEST)) & ((id_ex_curr->destm) == (id_ex_next->srca) || 
